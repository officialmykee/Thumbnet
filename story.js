  ...
  container.innerHTML = `
    ...
    <div class="story-item">
      <div class="story-avatar-wrap">
        <div class="story-photo">
          <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:100%;display:block;">
    ...
    <div class="story-item">
      <div class="story-avatar-wrap">
        <div class="story-ring"></div>
        <div class="story-photo">
          <img src="https://randomuser.me/api/portraits/men/52.jpg" alt="Roman"/>
        </div>
      </div>
    ...
    <div class="story-item">
      ...
      <span class="story-label">Sophie</span>
    </div>
    ...
    <div class="story-item">
      ...
      <span class="story-label">James</span>
    </div>
  `;
}
